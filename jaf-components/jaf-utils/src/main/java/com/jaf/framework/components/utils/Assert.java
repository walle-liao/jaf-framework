package com.jaf.framework.components.utils;


import com.jaf.framework.components.utils.common.CollectionUtils;
import com.jaf.framework.components.utils.common.ObjectUtils;
 ...
 *
 * <p>
 * For example, if the contractData of a public method states it does not allow <code>null</code> arguments, Assert can be
 * used to validate that contractData. Doing this clearly indicates a contractData violation when it occurs and protects the
 * class's invariants.
 *
 * <p>
